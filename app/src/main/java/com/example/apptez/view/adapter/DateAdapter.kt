...
class DateAdapter():RecyclerView.Adapter<DateAdapter.ViewHolder>(),DateClickListener {
...
//context: Context, val dateDeleteClickInterface: DateDeleteClickInterface
    ...
    class ViewHolder(view: View):RecyclerView.ViewHolder(view) {
     ...
     val nameHost=view.findViewById<TextView>(R.id.hospitalName)
     val nameDoc=view.findViewById<TextView>(R.id.doctorName)
     val date=view.findViewById<TextView>(R.id.date)

        fun bind(checkUpDate: CheckUpDate){
            nameHost.setText(checkUpDate.Hospital)
            nameDoc.setText(checkUpDate.Doctor)
            date.setText(checkUpDate.Date.toString())
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.r_rowcu,parent,false)
